...
///
/// \file
/// This file contains declaration of TMP1075 class which is a driver for
/// TMP1075 temperature sensor. The alert functionalisty is not implemented.
///===-----------------------------------------------------------------------------------------===//
...
typedef bool (*tmp1075_I2C_write)(uint8_t address, uint8_t reg, uint8_t *data,
                                  uint8_t len);
typedef bool (*tmp1075_I2C_read)(uint8_t address, uint8_t reg, uint8_t *data,
                                 uint8_t len);
