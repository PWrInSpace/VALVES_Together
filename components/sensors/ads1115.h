...
///
/// \file
/// This file contains declaration of ADS1115 driver. It is used to read data
/// from ADS1115 analog to digital converter.
///===-----------------------------------------------------------------------------------------===//
...
typedef bool (*ads1115_I2C_write)(uint8_t address, uint8_t reg, uint8_t *data,
                                  uint8_t len);
typedef bool (*ads1115_I2C_read)(uint8_t address, uint8_t reg, uint8_t *data,
                                 uint8_t len);
 ...
 *
 * @note Get number of the comparator conversions before pin ALERT/RDY
 * assertion.
 *
 * @param ads1115 device instance pointer
 ...
 *
 * @note Set number of the comparator conversions before pin ALERT/RDY assertion
 * or disable comparator.
 *
 * @param ads1115 device instance pointer
