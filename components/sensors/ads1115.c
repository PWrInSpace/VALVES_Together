...
const float ads1115_gain_values[] = {
    [ADS1115_GAIN_6V144] = 6.144,   [ADS1115_GAIN_4V096] = 4.096,
    [ADS1115_GAIN_2V048] = 2.048,   [ADS1115_GAIN_1V024] = 1.024,
    [ADS1115_GAIN_0V512] = 0.512,   [ADS1115_GAIN_0V256] = 0.256,
    [ADS1115_GAIN_0V256_2] = 0.256, [ADS1115_GAIN_0V256_3] = 0.256};

///===-----------------------------------------------------------------------------------------===//

static ads1115_status_t read_reg_2b(ads1115_struct_t *ads1115, uint8_t reg,
                                    uint16_t *val) {
  bool ret = true;
  uint8_t buf[2];
...
static ads1115_status_t write_reg_2b(ads1115_struct_t *ads1115, uint8_t reg,
                                     uint16_t val) {
  bool ret = true;
...
static ads1115_status_t read_conf_bits(ads1115_struct_t *ads1115, uint8_t offs,
                                       uint16_t mask, uint16_t *bits) {
...
static ads1115_status_t write_conf_bits(ads1115_struct_t *ads1115, uint16_t val,
                                        uint8_t offs, uint16_t mask) {
  ads1115_status_t ret = ADS1115_OK;
  uint16_t old;
  ...
  ret = write_reg_2b(ads1115, REG_CONFIG,
                     (old & ~(mask << offs)) | (val << offs));
  if (ret != ADS1115_OK) {
...
ads1115_status_t ads1115_get_gain(ads1115_struct_t *ads1115,
                                  ads1115_gain_t *gain) {
...
ads1115_status_t ads1115_set_gain(ads1115_struct_t *ads1115,
                                  ads1115_gain_t gain) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_input_mux(ads1115_struct_t *ads1115,
                                       ads1115_mux_t *mux) {
...
ads1115_status_t ads1115_set_input_mux(ads1115_struct_t *ads1115,
                                       ads1115_mux_t mux) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_mode(ads1115_struct_t *ads1115,
                                  ads1115_mode_t *mode) {
...
ads1115_status_t ads1115_set_mode(ads1115_struct_t *ads1115,
                                  ads1115_mode_t mode) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_data_rate(ads1115_struct_t *ads1115,
...
ads1115_status_t ads1115_set_data_rate(ads1115_struct_t *ads1115,
                                       ads1115_data_rate_t rate) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_mode(ads1115_struct_t *ads1115,
...
ads1115_status_t ads1115_set_comp_mode(ads1115_struct_t *ads1115,
                                       ads1115_comp_mode_t mode) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_polarity(ads1115_struct_t *ads1115,
...
ads1115_status_t ads1115_set_comp_polarity(ads1115_struct_t *ads1115,
                                           ads1115_comp_polarity_t polarity) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_latch(ads1115_struct_t *ads1115,
...
ads1115_status_t ads1115_set_comp_latch(ads1115_struct_t *ads1115,
                                        ads1115_comp_latch_t latch) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_queue(ads1115_struct_t *ads1115,
...
ads1115_status_t ads1115_set_comp_queue(ads1115_struct_t *ads1115,
                                        ads1115_comp_queue_t queue) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_low_thresh(ads1115_struct_t *ads1115,
                                             int16_t *th) {
...
ads1115_status_t ads1115_set_comp_low_thresh(ads1115_struct_t *ads1115,
                                             int16_t th) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_get_comp_high_thresh(ads1115_struct_t *ads1115,
                                              int16_t *th) {
  if (ads1115 == NULL || th == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
...
ads1115_status_t ads1115_set_comp_high_thresh(ads1115_struct_t *ads1115,
                                              int16_t th) {
  if (ads1115 == NULL) {
    ESP_LOGE(TAG, "Invalid argument - NULL check failed");
    return ADS1115_NULL_ARG;
