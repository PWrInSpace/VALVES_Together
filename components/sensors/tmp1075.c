...
static tmp1075_status_t write_reg_16b(tmp1075_struct_t *tmp1075,
                                      const uint8_t reg, uint16_t val) {
  bool ret = true;
...
static tmp1075_status_t read_reg_16b(tmp1075_struct_t *tmp1075,
                                     const uint8_t reg, uint16_t *val) {
  bool ret = true;
  uint8_t data[2];
...
tmp1075_status_t tmp1075_get_temp_celsius(tmp1075_struct_t *tmp1075,
                                          float *celsius) {
  tmp1075_status_t ret = TMP1075_OK;
  int16_t raw_temp = 0;
...
tmp1075_status_t tmp1075_get_conv_mode(tmp1075_struct_t *tmp1075,
                                       bool *is_single_shot) {
  *is_single_shot =
      (bool)((tmp1075->config_register >> TMP1075_OFFSET_SD) & 0b1);
  return TMP1075_OK;
}

tmp1075_status_t tmp1075_set_conv_mode(tmp1075_struct_t *tmp1075,
                                       const bool is_single_shot) {
  tmp1075_status_t ret = TMP1075_OK;
  uint8_t reg_val = 0;

  reg_val = (uint8_t)(tmp1075->config_register & ~(1 << TMP1075_OFFSET_SD)) |
            ((uint8_t)is_single_shot << TMP1075_OFFSET_SD);
  ret = write_reg_8b(tmp1075, TMP1075_REG_CONFIG, reg_val);
  if (ret != TMP1075_OK) {
    return ret;
  }
...
tmp1075_status_t tmp1075_get_conv_time(tmp1075_struct_t *tmp1075,
                                       tmp1075_conversion_time_t *conv_time) {
  *conv_time = (tmp1075_conversion_time_t)((tmp1075->config_register >>
                                            TMP1075_OFFSET_R) &
                                           0b11);
  return TMP1075_OK;
}
...
tmp1075_status_t
tmp1075_set_conv_time(tmp1075_struct_t *tmp1075,
                      const tmp1075_conversion_time_t conv_time) {
  tmp1075_status_t ret = TMP1075_OK;
  uint8_t reg_val = 0;

  if (((tmp1075_conversion_time_t)(tmp1075->config_register >>
                                   TMP1075_OFFSET_R) &
       0b11) != conv_time) {
    return TMP1075_OK;
  }

  reg_val = (uint8_t)(tmp1075->config_register & ~(0b11 << TMP1075_OFFSET_R)) |
            ((uint8_t)conv_time << TMP1075_OFFSET_R);
  ret = write_reg_8b(tmp1075, TMP1075_REG_CONFIG, reg_val);
  if (ret != TMP1075_OK) {
    return ret;
  }
