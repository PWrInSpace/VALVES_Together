...
typedef enum {
  ...
  FUELING_PERIOD = 400,
  PRESSURIZING_PERIOD = 400,
  ARMED_TO_LAUNCH_PERIOD = 400,
  RDY_TO_LAUNCH_PERIOD = 400,
  COUNTDOWN_PERIOD = 400,
  LIFT_OFF_PERIOD = 100,
  BURN_PERIOD = 100,
  FLIGHT_PERIOD = 100,
  FIRST_STAGE_REC_PERIOD = 1000,
  SECOND_STAGE_REC_PERIOD = 1000,
  ON_GROUND_PERIOD = 1000,
  HOLD_PERIOD = 1000,
  ABORT_PERIOD = 1000,
} Periods;
...
typedef enum {
  ...
  SD_BURN_PERIOD = 10,
  SD_FLIGHT_PERIOD = 10,
  SD_FIRST_STAGE_REC_PERIOD = 10,
  SD_SECOND_STAGE_REC_PERIOD = 10,
