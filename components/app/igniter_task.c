...
//       ESP_LOGE(TAG, "Igniter continuity check failed with status %d",
//       status);
//     }
...
//   BaseType_t result = xTaskCreate(igniter_task, "igniter_task", 8192, NULL,
//   5,
//                                   &igniter_task_handle);
...
// Unused on euroc 2026 setup, but can be used for future
